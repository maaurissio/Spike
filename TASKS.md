...
- [ ] Llevar a la TUI el timeline compacto solicitado: tres filas de cantidades (`1K/4K`, `R1/R2`, `0D/2D`) entre aliados y enemigos, con datos confirmados y ronda actual pendiente.
